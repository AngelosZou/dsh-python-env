 ...
 * 7. Optional, zero-dependency compatibility with dsh-multi-folder: each
 *    tool silently probes ctx.get('multiFolder') at call time (never
 *    declared in inject). Absent, the plugin behaves exactly as if
 *    multi-folder did not exist; present, the user-configured secondary
 *    working directories join the primary workspace as allowed roots.
 */
