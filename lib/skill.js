...
## Use the tools
- \`pyenv_discover\` — find existing virtual environments in the workspace (up to two levels deep, by the pyvenv.cfg marker or common names: .venv, venv, env, .env, virtualenv). Reports path, interpreter, version, and pip availability. Read-only.
