...
/** Generic oneOf schema for tools whose result is a single process run. */
export const PROCESS_SCHEMA = { oneOf: [BACKGROUND_BRANCH, FOREGROUND_BRANCH, ERROR_BRANCH] }
...
export function renderProcessValue(value) {
...
export const PROCESS_RENDER = (_args, value) => [{ type: 'text', text: renderProcessValue(value) }]
